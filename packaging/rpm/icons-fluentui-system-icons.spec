...
Name:           icons-fluentui-system-icons
Version:        %{version}
Release:        1%{?dist}
Summary:        Fluent UI System Icons
...
.
Provides icon assets under /usr/share/icons-fluentui-system-icons, a preview index, and a
launcher `icons-fluentui-system-icons` (`iconlib -l fluentui-system-icons`).
...
%files
%{_bindir}/icons-fluentui-system-icons
%{_datadir}/bash-completion/completions/icons-fluentui-system-icons
%{_mandir}/man1/icons-fluentui-system-icons.1*
%{_datadir}/icons-fluentui-system-icons/
%{_datadir}/doc/icons-fluentui-system-icons/
