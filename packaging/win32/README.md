...
.\build.ps1 -Name icons-fluentui-system-icons -Version 1.2.3
```
...
```
<project>/.config/icons-fluentui-system-icons/<packaging>.build-host
$HOME/.config/icons-fluentui-system-icons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-fluentui-system-icons
```
